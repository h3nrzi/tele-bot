...
import { getBuyerMainMenuKeyboard, getAdminMainMenuKeyboard } from "@/bot/keyboards/menu.keyboards";
...
export async function handleStart(
	...
	const displayName = ctx.from.first_name?.trim() || (ctx.from.username ? `@${ctx.from.username}` : null);
