...
export const BUYER_BOT_COMMANDS: BotCommand[] = [
	...
	{ command: "account", description: "👤 مشاهده و مدیریت حساب کاربری" },
	{ command: "shop", description: "🛍️ مشاهده و خرید خدمات کاتالوگ" },
	{ command: "myorder", description: "📦 پیگیری و تاریخچه سفارش‌ها" },
...
export const ADMIN_BOT_COMMANDS: BotCommand[] = [
	...
	{
		command: "setrate",
		description: "✏️ تنظیم نرخ لحظه‌ای تبدیل ارز (ریال به دلار)",
	},
	{ command: "rate", description: "💱 مشاهده نرخ تبدیل ارز فعال" },
	{
		command: "setcard",
		description: "💳 تنظیم یا به‌روزرسانی کارت بانکی واریز",
	},
];

export async function setupBotCommands(api: Api, adminIdsSource?: string | Set<bigint>): Promise<void> {
