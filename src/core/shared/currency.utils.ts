 ...
 */
export function formatIrr(amount: bigint | number | string | Decimal | IrrAmount): string {
...
export function computeIrrAmount(
	...
	const rate = irrPerUsd instanceof Decimal ? irrPerUsd : new Decimal(irrPerUsd.toString());
...
export function calculateSpreadAdjustedRate(
	...
	const otcDec = otcIrrPerUsd instanceof Decimal ? otcIrrPerUsd : new Decimal(otcIrrPerUsd.toString());
	const spreadDec = spreadPercent instanceof Decimal ? spreadPercent : new Decimal(spreadPercent.toString());
