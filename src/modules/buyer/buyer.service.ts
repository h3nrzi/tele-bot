...
export class BuyerService {
	 ...
	 */
	public async register(input: RegisterBuyerInput, executor?: DbExecutor): Promise<RegisterBuyerResult> {
	 ...
	 */
	public async findByTelegramChatId(telegramChatId: bigint | number, executor?: DbExecutor): Promise<Buyer | null> {
	 ...
	 */
	public async registerBuyer(input: RegisterBuyerInput, executor?: DbExecutor): Promise<RegisterBuyerResult> {
