...
export const orders = pgTable("orders", {
	...
	usdPriceSnapshot: numeric("usd_price_snapshot", {
		precision: 18,
		scale: 2,
	}).notNull(),
	...
	claimedByAdminTelegramId: bigint("claimed_by_admin_telegram_id", {
		mode: "bigint",
	}),
...
export const orderAdminNotificationsRelations = relations(orderAdminNotifications, ({ one }) => ({
	order: one(orders, {
