...
export const topUpRequests = pgTable(
	"top_up_requests",
	{
		...
		processedByAdminTelegramId: bigint("processed_by_admin_telegram_id", {
			mode: "bigint",
		}),
...
export type TopUpRequestRow = TopUpRequestSchema;
export type NewTopUpRequestRow = NewTopUpRequestSchema;
