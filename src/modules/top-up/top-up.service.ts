...
import { TopUpRequestRepository } from '@/modules/top-up/top-up.repository';
...
export async function initiateTopUp(
  ...
  return await service.initiateTopUp(input, limits, executor);
}
...
export async function getActiveTopUpRequest(
  ...
  return await service.getActiveTopUpRequest(userId, executor);
}
...
export async function submitReceipt(
  ...
  return await service.submitReceipt(input, options, executor);
}
...
export async function approveTopUp(
  ...
  return await service.approveTopUp(input, dependencies, executor);
}
...
export async function rejectTopUp(
  ...
  return await service.rejectTopUp(input, dependencies, executor);
}
...
export async function cancelTopUp(
  ...
  return await service.cancelTopUp(input, options, executor);
}
...
export async function getLatestTopUpRequest(
  ...
  return await service.getLatestTopUpRequest(userId, executor);
}
...
export async function getPendingRequests(
  ...
  return await service.getPendingRequests(executor);
}
