...
export const otcPurchaseStatusEnum = pgEnum('otc_purchase_status', [
  'PENDING',
  'COMPLETED',
  'FAILED',
]);
...
export const wallexOtcPurchases = pgTable(
  'wallex_otc_purchases',
  {
    ...
    usdtQuantity: numeric('usdt_quantity', { precision: 18, scale: 2 }).notNull(),
    ...
    wallexExecutedQty: numeric('wallex_executed_qty', { precision: 18, scale: 8 }),
...
export const wallexOtcPurchasesRelations = relations(
  wallexOtcPurchases,
  ({ one }) => ({
